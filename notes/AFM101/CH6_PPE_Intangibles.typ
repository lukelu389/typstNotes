...
#align(center)[
  #table(
    ...
    [Units-of-Production],[1. D/U: $frac(C-R, U)$
                           2. D/U $dot$ Activity$ =$ Dep. Exp],[Wear out because of wear],
    [Diminishing-Balance (DDB)], [1. Straight-Line  $dot$ 2= DDB rate
    2. 
    $P_1$ = Cost $dot$ DDB\
    $P_2$ = Carrying Value $dot$ DDB 
    (Cost - Dep($P_1$)) 
    $P_(n)$ = Difference ], [Generate revenue early in useful life]
  )
]
\
\
